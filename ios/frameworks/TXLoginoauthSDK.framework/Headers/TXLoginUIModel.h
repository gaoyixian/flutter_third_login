...
-(void)setPresentAnimated:(BOOL)presentAnimated;
-(BOOL)presentAnimated;

- (void)setTxMobliNumberOffsetY:(NSNumber*)txMobliNumberOffsetY;
-(NSNumber*)txMobliNumberOffsetY;
...
-(void)setSloganHidden:(BOOL)sloganHidden;
-(BOOL)sloganHidden;

-(void)setLogoFrame:(CGRect)logoFrame;
-(CGRect)logoFrame;

-(void)setBrandLabelTextSize:(UIFont*)brandLabelTextSize;
-(UIFont*)brandLabelTextSize;
...
-(void)setIfCreateCustomView:(BOOL )ifCreateCustomView;
-(BOOL)ifCreateCustomView;

-(void)setAppPrivacyDemo:(NSAttributedString *)appPrivacyDemo;
-(NSAttributedString *)appPrivacyDemo;

-(void)setAppPrivacy:(NSArray<NSAttributedString*>*)appPrivacy;
-(NSArray<NSAttributedString*>*)appPrivacy;
...
-(void)setLogBtnText:(NSAttributedString *)logBtnText;
-(NSAttributedString*)logBtnText;
...
-(void)setAppPrivacyOriginLR:(NSArray <NSNumber *> * )appPrivacyOriginLR;
-(NSArray <NSNumber *> *)appPrivacyOriginLR;

- (void)setSloganTextColor:(UIColor *)sloganTextColor;
-(UIColor *)sloganTextColor;

- (void)setNumberTextAttributes:(NSDictionary<NSAttributedStringKey,id> *)numberTextAttributes;
-(NSDictionary<NSAttributedStringKey,id> *)numberTextAttributes;

- (void)setSloganLabelOffsetY:(CGFloat)sloganLabelOffsetY;
-(CGFloat)sloganLabelOffsetY;

- (void)setNumberOffsetX:(NSNumber*)numberOffsetX;
-(NSNumber*)numberOffsetX;
...
- (void)setWebNavReturnImg:(UIImage*)webNavReturnImg;
-(UIImage *)webNavReturnImg;


- (void)setWebNavColor:(UIColor*)webNavColor;
-(UIColor *)webNavColor;

- (void)setWebNavTitleAttrs:(NSDictionary<NSAttributedStringKey,id>*)webNavTitleAttrs;
-(NSDictionary<NSAttributedStringKey,id>*)webNavTitleAttrs;


- (void)setCustomOtherLoginViews:(NSArray<UIView *>*)customOtherLoginViews;
-(NSArray<UIView *>*)customOtherLoginViews;

- (void)setCustomTopLoginView:(UIView*)customTopLoginView;
-(UIView *)customTopLoginView;
...
- (void)setFaceOrientation:(BOOL)faceOrientation;
-(BOOL)faceOrientation;


- (void)setCheckTipText:(NSString *)checkTipText;
-(NSString *)checkTipText;

- (void)setAuthWindow:(BOOL)authWindow;
-(BOOL)authWindow;
...
- (void)setControllerSize:(CGSize)controllerSize;
-(CGSize)controllerSize;

- (void)setEdgeWindow:(BOOL)edgeWindow;
-(BOOL)edgeWindow;


-(void)setAppLanguageType:(AuthLanguageType)appLanguageType;
-(AuthLanguageType)appLanguageType;

-(void)setIsShowLoginLoadingView:(BOOL)isShowLoginLoadingView;
-(BOOL)isShowLoginLoadingView;

-(void)setLoginLoadingView:(UIView*)loginLoadingView;
-(UIView*)loginLoadingView;

-(void)setPrivacyUncheckAnimation:(BOOL)privacyUncheckAnimation;
-(BOOL)privacyUncheckAnimation;
